...
__all__ = ['MoExResNet', 'moex_resnet18', 'moex_resnet34', 'moex_resnet50', 'moex_resnet101',
           'moex_resnet152', 'moex_resnext50_32x4d', 'moex_resnext101_32x8d',
...
class MoExResNet(nn.Module):
    ...
    def forward(self, x, ex_index=None, moex_norm='pono', moex_epsilon=1e-5,
...
def moex_resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    ...
    return _moex_resnet('moex_resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, progress, **kwargs)


def moex_resnext101_32x8d(pretrained=False, progress=True, **kwargs):
    ...
    return _moex_resnet('moex_resnext101_32x8d', Bottleneck, [3, 4, 23, 3],
                   pretrained, progress, **kwargs)
